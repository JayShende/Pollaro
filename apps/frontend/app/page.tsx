          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              <Image
                ...
                className="w-8 h-8"
              />
              <span className="text-xl font-bold text-gray-900">Pollaro</span>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <Button className="border border-gray-300 bg-white text-gray-700 shadow-sm hover:bg-gray-50 hover:border-gray-400 transition-all">
                <Link href="/auth/login" title="Sign In">
                  Sign In
                </Link>
              </Button>
              <Button className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-lg hover:from-indigo-700 hover:to-purple-700 transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Button className="text-lg px-8 py-6 h-auto bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-xl hover:from-indigo-700 hover:to-purple-700 transition-all transform hover:scale-105">
                Start for Free
                <ArrowRight className="w-5 h-5 ml-2" />
              </Button>
              <Button className="text-lg px-8 py-6 h-auto border border-gray-300 bg-white text-gray-700 shadow-lg hover:bg-gray-50 hover:border-gray-400 transition-all">
                ...
                <div className="bg-gray-50 rounded-lg p-6 mb-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex space-x-2">
                      <div className="h-8 bg-indigo-100 rounded w-20"></div>
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button className="text-lg px-8 py-6 h-auto bg-white text-indigo-600 shadow-xl hover:bg-gray-50 hover:shadow-2xl transition-all transform hover:scale-105 border border-white/20">
              Get Started Free
              <ArrowRight className="w-5 h-5 ml-2" />
            </Button>
            <Button className="text-lg px-8 py-6 h-auto border-2 border-white text-white hover:bg-white hover:text-indigo-600 bg-transparent transition-all">
              <Play className="w-5 h-5 mr-2" />
              Watch Demo
            </Button>
          </div>
